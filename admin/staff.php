...
<html lang="en">
  ...
  <head>
    ...
    <title>Administración de Empleados - Miku's Coffee</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Restaurante | Miku's Coffee</a>
          ...
          <div class="row">
            <div class="col-lg-8">
              <div class="card mb-3">
                ...
                <div class="card-footer small text-muted"><i>Contraseña predeterminada para nuevo usuario : 123456</i></div>
              </div>
            </div>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante Miku's Coffee 2021</span>
            </div>
          </div>
        </footer>
